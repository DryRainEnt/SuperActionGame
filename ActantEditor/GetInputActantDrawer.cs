...
namespace Editor.SimpleActionEditor.ActantEditor
{
	...
	public class GetInputActantDrawer : PropertyDrawer
	{
	 	...
	 	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	 	{
	 	 	...
	 	 	EditorGUILayout.LabelField("GetInputActant");
	 	 	// Put your code here
	 	 	...
	 	 	foldout = EditorGUI.Foldout(position, foldout, $"{startFrameProperty.intValue} ~ GetInputActant [{durationProperty.intValue}]", true);
	 	 	pCount++;
