...
{
	[CustomPropertyDrawer(typeof(SetGravityFactorActant))]
	public class SetGravityFactorDrawer : PropertyDrawer
	{
	 	...
	 	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	 	{
	 	 	...
	 	 	SerializedProperty gravityProperty = property.FindPropertyRelative("GravityFactor");
	 	 	...
	 	 	// Put your code here
		    drawRect = new Rect(position.x, position.y + 24f * pCount, position.width, position.height);
		    EditorGUI.PropertyField(drawRect, gravityProperty, 
			    new GUIContent("GravityFactor"), true);
		    pCount++;
