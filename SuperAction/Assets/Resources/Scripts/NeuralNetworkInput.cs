...
namespace Resources.Scripts
{
	...
	{
		public CustomNeuralNetwork NeuralNetwork => NN_Manager.Instance.NeuralNetwork;
		...
		public void InputCheck(Actor actor, string key)
		{
            ...
            inputAxis.Value = new Vector2(input.x, input.y);
            commandAxis.Value = new Vector2(input.z, input.w);
